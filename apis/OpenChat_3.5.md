...
<h1 id="openchat-3-5">OpenChat 3.5 v1.0.0</h1>
...
<h1 id="openchat-3-5-default">Default</h1>
...
*Call API using model OpenChat 3.5*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"openchat/openchat-7b\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "openchat/openchat-7b". The model name to use|
