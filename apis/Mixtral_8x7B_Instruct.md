...
<h1 id="mixtral-8x7b-instruct">Mixtral 8x7B Instruct v1.0.0</h1>
...
<h1 id="mixtral-8x7b-instruct-default">Default</h1>
...
*Call API using model Mixtral 8x7B Instruct*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"mistralai/mixtral-8x7b-instruct\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "mistralai/mixtral-8x7b-instruct". The model name to use|
