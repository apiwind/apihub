...
<h1 id="anthropic-claude-3-opus-self-moderated-self-moderated-variant">Anthropic: Claude 3 Opus (self-moderated)Self-moderated variant v1.0.0</h1>
...
<h1 id="anthropic-claude-3-opus-self-moderated-self-moderated-variant-default">Default</h1>
...
*Call API using model Anthropic: Claude 3 Opus (self-moderated)Self-moderated variant*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"anthropic/claude-3-opus:beta\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "anthropic/claude-3-opus:beta". The model name to use|
