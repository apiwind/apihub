...
<h1 id="salesforce_blip">salesforce_blip v1.0.0</h1>
...
<h1 id="salesforce_blip-default">Default</h1>
...
```json
{
  "properties": {
    ...
    "version": {
      "description": "Eg: 2e1dddc8621f72155f24cf2e0adbde548458d3cab9f00c0139eea840d0ac4746. The ID of the model version",
      "type": "string"
    },
    "webhook": {
...
|»» caption|body|string|false|Type caption for the input image for image text matching task.|
|»» image|body|string(uri)|true|Input image|
|»» question|body|string|false|Type question for the input image for visual question answering task.|
|»» task|body|string|false|Choose a task.|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: 2e1dddc8621f72155f24cf2e0adbde548458d3cab9f00c0139eea840d0ac4746. The ID of the model version|
