...
<h1 id="mistral-tiny">Mistral Tiny v1.0.0</h1>
...
<h1 id="mistral-tiny-default">Default</h1>
...
*Call API using model Mistral Tiny*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"mistralai/mistral-tiny\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "mistralai/mistral-tiny". The model name to use|
