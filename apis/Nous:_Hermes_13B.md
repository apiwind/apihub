...
<h1 id="nous-hermes-13b">Nous: Hermes 13B v1.0.0</h1>
...
<h1 id="nous-hermes-13b-default">Default</h1>
...
*Call API using model Nous: Hermes 13B*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"nousresearch/nous-hermes-llama2-13b\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "nousresearch/nous-hermes-llama2-13b". The model name to use|
