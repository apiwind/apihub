...
<h1 id="abiruyt_text-extract-ocr">abiruyt_text-extract-ocr v1.0.0</h1>
...
<h1 id="abiruyt_text-extract-ocr-default">Default</h1>
...
|»» image|body|string(uri)|true|Image to process|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: a524caeaa23495bc9edc805ab08ab5fe943afd3febed884a4f3747aa32e9cd61. The ID of the model version|
