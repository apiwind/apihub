...
<h1 id="andreasjansson_clip-features">andreasjansson_clip-features v1.0.0</h1>
...
<h1 id="andreasjansson_clip-features-default">Default</h1>
...
```json
{
  "properties": {
    ...
    "version": {
      "description": "Eg: 75b33f253f7714a281ad3e9b28f63e3232d583716ef6718f2e46641077ea040a. The ID of the model version",
      "type": "string"
    },
    "webhook": {
...
|»» inputs|body|string|false|Newline-separated inputs. Can either be strings of text or image URIs starting with http[s]://|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: 75b33f253f7714a281ad3e9b28f63e3232d583716ef6718f2e46641077ea040a. The ID of the model version|
