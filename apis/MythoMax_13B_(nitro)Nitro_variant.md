...
<h1 id="mythomax-13b-nitro-nitro-variant">MythoMax 13B (nitro)Nitro variant v1.0.0</h1>
...
<h1 id="mythomax-13b-nitro-nitro-variant-default">Default</h1>
...
*Call API using model MythoMax 13B (nitro)Nitro variant*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"gryphe/mythomax-l2-13b:nitro\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "gryphe/mythomax-l2-13b:nitro". The model name to use|
