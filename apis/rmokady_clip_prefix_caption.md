...
<h1 id="rmokady_clip_prefix_caption">rmokady_clip_prefix_caption v1.0.0</h1>
...
<h1 id="rmokady_clip_prefix_caption-default">Default</h1>
...
```json
{
  "properties": {
    ...
    "version": {
      "description": "Eg: 9a34a6339872a03f45236f114321fb51fc7aa8269d38ae0ce5334969981e4cd8. The ID of the model version",
      "type": "string"
    },
    "webhook": {
...
|»» model|body|string|false|Choose a model|
|»» use_beam_search|body|boolean|false|Whether to apply beam search to generate the output text|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: 9a34a6339872a03f45236f114321fb51fc7aa8269d38ae0ce5334969981e4cd8. The ID of the model version|
