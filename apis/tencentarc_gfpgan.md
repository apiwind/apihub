...
|»» img|body|string(uri)|true|Input|
|»» scale|body|number|false|Rescaling factor|
|»» version|body|string|false|GFPGAN version. v1.3: better quality. v1.4: more details and better identity.|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: 0fbacf7afc6c144e5be9767cff80f25aff23e52b0708f17e20f9879b2f21516c. The ID of the model version|
