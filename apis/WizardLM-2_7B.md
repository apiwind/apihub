...
<h1 id="wizardlm-2-7b">WizardLM-2 7B v1.0.0</h1>
...
<h1 id="wizardlm-2-7b-default">Default</h1>
...
*Call API using model WizardLM-2 7B*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"microsoft/wizardlm-2-7b\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "microsoft/wizardlm-2-7b". The model name to use|
