...
<h1 id="mistral-7b-instruct">Mistral 7B Instruct v1.0.0</h1>
...
<h1 id="mistral-7b-instruct-default">Default</h1>
...
*Call API using model Mistral 7B Instruct*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"mistralai/mistral-7b-instruct\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "mistralai/mistral-7b-instruct". The model name to use|
