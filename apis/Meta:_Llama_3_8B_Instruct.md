...
<h1 id="meta-llama-3-8b-instruct">Meta: Llama 3 8B Instruct v1.0.0</h1>
...
<h1 id="meta-llama-3-8b-instruct-default">Default</h1>
...
*Call API using model Meta: Llama 3 8B Instruct*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"meta-llama/llama-3-8b-instruct\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "meta-llama/llama-3-8b-instruct". The model name to use|
