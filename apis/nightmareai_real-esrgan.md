...
<h1 id="nightmareai_real-esrgan">nightmareai_real-esrgan v1.0.0</h1>
...
<h1 id="nightmareai_real-esrgan-default">Default</h1>
...
```json
{
  "properties": {
    ...
    "version": {
      "description": "Eg: 350d32041630ffbe63c8352783a26d94126809164e54085352f8326e53999085. The ID of the model version",
      "type": "string"
    },
    "webhook": {
...
|»» face_enhance|body|boolean|false|Face enhance|
|»» image|body|string(uri)|true|Input image|
|»» scale|body|number|false|Factor to scale image by|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: 350d32041630ffbe63c8352783a26d94126809164e54085352f8326e53999085. The ID of the model version|
