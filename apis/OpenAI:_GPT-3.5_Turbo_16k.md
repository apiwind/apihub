...
<h1 id="openai-gpt-3-5-turbo-16k">OpenAI: GPT-3.5 Turbo 16k v1.0.0</h1>
...
<h1 id="openai-gpt-3-5-turbo-16k-default">Default</h1>
...
*Call API using model OpenAI: GPT-3.5 Turbo 16k*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"openai/gpt-3.5-turbo-0125\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "openai/gpt-3.5-turbo-0125". The model name to use|
