...
<h1 id="openai-gpt-4o">OpenAI: GPT-4o v1.0.0</h1>
...
<h1 id="openai-gpt-4o-default">Default</h1>
...
*Call API using model OpenAI: GPT-4o*
...
```json
{
  "properties": {
    ...
    "model": {
      "description": "Eg: \"openai/gpt-4o\". The model name to use",
      "type": "string"
    },
    "presence_penalty": {
      "default": "0.0",
...
|» model|body|string|true|Eg: "openai/gpt-4o". The model name to use|
