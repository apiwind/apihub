...
<h1 id="sczhou_codeformer">sczhou_codeformer v1.0.0</h1>
...
<h1 id="sczhou_codeformer-default">Default</h1>
...
```json
{
  "properties": {
    ...
    "version": {
      "description": "Eg: 7de2ea26c616d5bf2245ad0d5e24f0ff9a6204578a5c876db53142edd9d2cd56. The ID of the model version",
      "type": "string"
    },
    "webhook": {
...
|»» background_enhance|body|boolean|false|Enhance background image with Real-ESRGAN|
|»» codeformer_fidelity|body|number|false|Balance the quality (lower number) and fidelity (higher number).|
|»» face_upsample|body|boolean|false|Upsample restored faces for high-resolution AI-created images|
|»» image|body|string(uri)|true|Input image|
|»» upscale|body|integer|false|The final upsampling scale of the image|
|» stream|body|boolean|false|Request a URL to receive streaming output using server-sent events (SSE).|
|» version|body|string|true|Eg: 7de2ea26c616d5bf2245ad0d5e24f0ff9a6204578a5c876db53142edd9d2cd56. The ID of the model version|
