...
|»» image|body|string(uri)|false|An image of a person to be converted to a sticker|
|»» instant_id_strength|body|number|false|How strong the InstantID will be.|
|»» ip_adapter_noise|body|number|false|How much noise is added to the IP adapter input|
|»» ip_adapter_weight|body|number|false|How much the IP adapter will influence the image|
...
|»» steps|body|integer|false|none|
|»» upscale|body|boolean|false|2x upscale the sticker|
|»» upscale_steps|body|integer|false|Number of steps to upscale|
