...
<h1 id="google-gemini-pro-1-0">Google: Gemini Pro 1.0 v1.0.0</h1>
...
<h1 id="google-gemini-pro-1-0-default">Default</h1>
...
*Call API using model Google: Gemini Pro 1.0*
...
|» model|body|string|true|Eg: "google/gemini-pro". The model name to use|
